...
```typescript
// Example:
// Partner generates $7,800 revenue (78 conversions × $100)
// Partner earns: $7,800 × 10% = $780
// Manager earns: $780 × 10% = $78
...
### Revenue Calculation
```typescript
// Partner 1: 78 conversions × $100 = $7,800
// Partner 1 earns: $7,800 × 10% = $780
// Manager from Partner 1: $780 × 10% = $78
...
1. Calculate partner revenue: `conversions × conversion_value × 0.10`
2. Calculate manager revenue: `sum(partner_revenue × 0.10)`
