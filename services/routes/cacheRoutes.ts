...
import ResultsCacheService from '../src/services/resultsCacheService';
...
router.post('/save', async (req: Request<{}, SuccessResponse | ErrorResponse, SaveCacheRequest>, res: Response<SuccessResponse | ErrorResponse>) => {
  try {
...
router.get('/get', async (req: Request<{}, any, {}, { q: string }>, res: Response) => {
  try {
    const { q } = req.query;
...
router.get('/similar', async (req: Request<{}, any, {}, { q: string }>, res: Response) => {
  try {
    const { q } = req.query;
...
router.delete('/delete/:id', async (req: Request<{ id: string }>, res: Response<SuccessResponse | ErrorResponse>) => {
  try {
    const { id } = req.params;
...
router.post('/cleanup', async (req: Request, res: Response<SuccessResponse | ErrorResponse>) => {
  try {
...
router.get('/stats', async (req: Request, res: Response<SuccessResponse | ErrorResponse>) => {
  try {
