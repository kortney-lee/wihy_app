    ...
    return (
      <div className="pricing-page">
        ...
        <div className="pricing-content">
          ...
          {/* Comparison Section - Stacked Cards */}
          <section className="comparison-section">
            <div className="comparison-container">
              ...
              <div className="comparison-grid">
                ...
                <div className="comparison-card">
                  ...
                  <div className="comparison-card-body">
                    <div className="comparison-row">
                      ...
                      <span className="comparison-value">Food and fitness tracking with a large database</span>
                    </div>
                    <div className="comparison-row">
                      <span className="comparison-label">Scope Notes</span>
                      <span className="comparison-value">Tracking/logging centric. Insights depend on what the user logs and reviews over time.</span>
                    </div>
                    <div className="comparison-wihy-box">
                      <span className="comparison-label">WiHY Delivers</span>
                      <span className="comparison-value">Turns inputs into contextual insights and generates individualized meal/workout recommendations.</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="comparison-card">
                  ...
                  <div className="comparison-card-body">
                    <div className="comparison-row">
                      <span className="comparison-label">Their Stated Focus</span>
                      <span className="comparison-value">Photo/barcode scanning for fast nutrition tracking</span>
                    </div>
                    <div className="comparison-row">
                      <span className="comparison-label">Scope Notes</span>
                      <span className="comparison-value">Primarily designed for tracking. Ingredient processing context and individualized planning may not be central to the core workflow.</span>
                    </div>
                    <div className="comparison-wihy-box">
                      <span className="comparison-label">WiHY Delivers</span>
                      <span className="comparison-value">Adds ingredient + processing context and can generate individualized meals and workouts based on the user's goals, preferences, and constraints.</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="comparison-card">
                  ...
                  <div className="comparison-card-body">
                    <div className="comparison-row">
                      <span className="comparison-label">Their Stated Focus</span>
                      <span className="comparison-value">Product scoring based on nutrition-related factors and ingredients</span>
                    </div>
                    <div className="comparison-row">
                      <span className="comparison-label">Scope Notes</span>
                      <span className="comparison-value">Score-based guidance. Deeper personalization and lifestyle planning are typically outside a scanner-first workflow.</span>
                    </div>
                    <div className="comparison-wihy-box">
                      <span className="comparison-label">WiHY Delivers</span>
                      <span className="comparison-value">Explains relevance to the individual and can generate personalized meal and workout recommendations using user inputs.</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="comparison-card">
                  ...
                  <div className="comparison-card-body">
                    <div className="comparison-row">
                      <span className="comparison-label">Their Stated Focus</span>
                      <span className="comparison-value">Detailed nutrient tracking with emphasis on micronutrients</span>
                    </div>
                    <div className="comparison-row">
                      <span className="comparison-label">Scope Notes</span>
                      <span className="comparison-value">Designed for depth and precision; typically benefits from consistent entry and review.</span>
                    </div>
                    <div className="comparison-wihy-box">
                      <span className="comparison-label">WiHY Delivers</span>
                      <span className="comparison-value">Automates interpretation and connects nutrition patterns to behavior and lifestyle context.</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="comparison-card">
                  ...
                  <div className="comparison-card-body">
                    <div className="comparison-row">
                      <span className="comparison-label">Their Stated Focus</span>
                      <span className="comparison-value">Behavior-change program with lessons and tracking tools</span>
                    </div>
                    <div className="comparison-row">
                      <span className="comparison-label">Scope Notes</span>
                      <span className="comparison-value">Curriculum/behavior oriented; nutrition depth and outputs vary by program design.</span>
                    </div>
                    <div className="comparison-wihy-box">
                      <span className="comparison-label">WiHY Delivers</span>
                      <span className="comparison-value">Integrates behavior signals with food/ingredient context and produces individualized meal and workout recommendations.</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="comparison-card">
                  ...
                  <div className="comparison-card-body">
                    <div className="comparison-row">
                      <span className="comparison-label">Their Stated Focus</span>
                      <span className="comparison-value">Activity and wearable ecosystem with optional nutrition logging</span>
                    </div>
                    <div className="comparison-row">
                      <span className="comparison-label">Scope Notes</span>
                      <span className="comparison-value">Wearable-first experience; food insights are typically part of a broader activity platform.</span>
                    </div>
                    <div className="comparison-wihy-box">
                      <span className="comparison-label">WiHY Delivers</span>
                      <span className="comparison-value">Acts as an interpretation layer across food + activity and generates user-specific plans.</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="comparison-card">
                  ...
                  <div className="comparison-card-body">
                    <div className="comparison-row">
                      <span className="comparison-label">Their Stated Focus</span>
                      <span className="comparison-value">Health data aggregation, trends, and highlights</span>
                    </div>
                    <div className="comparison-row">
                      <span className="comparison-label">Scope Notes</span>
                      <span className="comparison-value">Primarily aggregates and displays data; recommendations depend on connected apps and sources.</span>
                    </div>
                    <div className="comparison-wihy-box">
                      <span className="comparison-label">WiHY Delivers</span>
                      <span className="comparison-value">Interprets patterns and offers individualized meal/workout recommendations based on user inputs and connected data where available.</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="comparison-card">
                  ...
                  <div className="comparison-card-body">
                    <div className="comparison-row">
                      <span className="comparison-label">Their Stated Focus</span>
                      <span className="comparison-value">Healthy eating plans, tracking, and recipes</span>
                    </div>
                    <div className="comparison-row">
                      <span className="comparison-label">Scope Notes</span>
                      <span className="comparison-value">Plan-and-tracking oriented; explanation depth varies by feature set and content model.</span>
                    </div>
                    <div className="comparison-wihy-box">
                      <span className="comparison-label">WiHY Delivers</span>
                      <span className="comparison-value">Adds research-informed explanations and generates recommendations based on user-specific constraints.</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="comparison-card">
                  ...
                  <div className="comparison-card-body">
                    <div className="comparison-row">
                      <span className="comparison-label">Their Stated Focus</span>
                      <span className="comparison-value">Recipes, meal planning, and shopping workflows</span>
                    </div>
                    <div className="comparison-row">
                      <span className="comparison-label">Scope Notes</span>
                      <span className="comparison-value">Cooking and meal planning oriented; health-intelligence depth depends on recipe metadata and integrations.</span>
                    </div>
                    <div className="comparison-wihy-box">
                      <span className="comparison-label">WiHY Delivers</span>
                      <span className="comparison-value">Adds ingredient/processing context and tailors recommendations to the individual.</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="comparison-card">
                  ...
                  <div className="comparison-card-body">
                    <div className="comparison-row">
                      <span className="comparison-label">Their Stated Focus</span>
                      <span className="comparison-value">AI food scanning and logging for calories and nutrition estimates</span>
                    </div>
                    <div className="comparison-row">
                      <span className="comparison-label">Scope Notes</span>
                      <span className="comparison-value">Logging/scanning oriented; broader coaching, behavior, and environment workflows may not be central to the core product design.</span>
                    </div>
                    <div className="comparison-wihy-box">
                      <span className="comparison-label">WiHY Delivers</span>
                      <span className="comparison-value">Connects food + behavior + activity and generates individualized meals and workouts based on user-specific inputs.</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="comparison-disclaimer">
                <p><strong>Note:</strong> Comparison reflects each product's publicly stated primary focus and typical use. Features may vary by plan, region, and updates. This is not a comprehensive feature audit.</p>
              </div>
            </div>
          </section>
