...
function getChartTypeTitle(chartType: ChartType): string {
  const titles: Record<ChartType, string> = {
    ...
    [ChartType.NUTRITION_ANALYSIS]: 'Nutrition Analysis',
    [ChartType.NUTRITION_CHART]: 'Nutrition Chart',
    [ChartType.NUTRITION_TRACKING]: 'Nutrition Tracking',
    [ChartType.NUTRITION_TRACKING_CHART]: 'Nutrition Tracking Chart',
    [ChartType.MACRONUTRIENTS]: 'Macronutrients',
    [ChartType.EXERCISE]: 'Exercise',
    ...
    [ChartType.RESEARCH_EVIDENCE_QUALITY]: 'Research Evidence Quality',
    [ChartType.RESEARCH_STUDY_TYPE_DISTRIBUTION]: 'Research Study Types',
    [ChartType.RESEARCH_PUBLICATION_TIMELINE]: 'Research Publications',
...
function getChartTypePriority(chartType: ChartType): number {
  const priorities: Record<ChartType, number> = {
    ...
    [ChartType.NUTRITION_ANALYSIS]: 46,
    [ChartType.NUTRITION_CHART]: 44,
    [ChartType.NUTRITION_TRACKING]: 52,
    [ChartType.NUTRITION_TRACKING_CHART]: 51,
    [ChartType.MACRONUTRIENTS]: 40,
    [ChartType.EXERCISE]: 71,
    ...
    [ChartType.RESEARCH_EVIDENCE_QUALITY]: 28,
    [ChartType.RESEARCH_STUDY_TYPE_DISTRIBUTION]: 26,
    [ChartType.RESEARCH_PUBLICATION_TIMELINE]: 24,
